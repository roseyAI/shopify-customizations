...
Added a new input to the form:

liquid
Copy
Edit
{%- render 'input', name: 'contact[full_name]', label: 'Full Name', type: 'text', autocomplete: 'name' -%}
Inserted this script at the bottom of the newsletter section (before {% schema %}):
